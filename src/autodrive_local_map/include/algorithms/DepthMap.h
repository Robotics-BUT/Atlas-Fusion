...
namespace AutoDrive::Algorithms {
    ...
    public:
        ...
        std::shared_ptr<std::vector<DataModels::YoloDetection3D>> onNewCameraData(std::shared_ptr<DataModels::CameraFrameDataModel>, DataModels::LocalPosition imuPose);
    ...
    private:
        ...
        void getAllCurrentPointsProjectedToImage(DataLoader::CameraIndentifier id, std::vector<cv::Point2f>& validPoints2D, std::vector<cv::Point3f>& validPoints3D, size_t img_width, size_t img_height, rtl::Transformation3D<double>);
